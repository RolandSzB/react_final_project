    ...
    <div className="flex flex-col bg-gradient-to-br from-gray-400 to-emerald-600">
      ...
      <div className="flex flex-row justify-center">
        <div className=" flex flex-col ms-12 mt-4 p-8">
          ...
          <button
            type="button"
            className="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200  font-medium rounded-lg text-xl px-5 py-4 text-center mt-40 mx-64 icon-jump"
          >
